  ...
  return (
    <div className="bg-white rounded p-4">
      ...
      <div className="bg-slate-300 rounded shadow-[inset_0px_2px_4px_#52525b]">
        <div className="h-7 bg-emerald-600 w-[70%] rounded mb-4">
      ...
      <div className="overflow-y-auto h-80">
        <ul className="mr-3">
          <li className="bg-gray-300 rounded p-3 mb-3">
            ...
            <button className="border border-slate-900 py-1 px-4 rounded text-sm font-semibold  hover:bg-emerald-500 transition duration-200 hover:border-transparent hover:text-white">
              Button
            </button>
          </li>
          <li className="bg-gray-300 rounded p-3 mb-3">
